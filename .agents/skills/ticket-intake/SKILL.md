...
Ticket you authored yourself: read `references/self-authored-carve.md` FIRST — 1KB that may retire the 31KB above. It carries one check the exemption never covers: the prescription you chose is the one thing same-session authorship cannot vouch for.
