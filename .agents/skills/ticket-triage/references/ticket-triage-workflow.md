...
4. **Adjacency sweep.** Has a similar ticket been filed and labeled? Quick `gh search issues --owner neomjs "<subject>"` (open and closed) to anchor the secondary-label decisions.
